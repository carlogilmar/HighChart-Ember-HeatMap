...
export default Route.extend({
	...
	model(){
		...
		let chartOptions = {
			...
			yAxis: {
				categories: ['Campus CMX', 'Campus LEO', 'Campus GDL', 'Campus SNL', 'Campus EMP', 'Campus VIR'],
				title: 'Campus'
			},
			colorAxis: {
				min: 0,
		...
		let chartData = [{
			...
			borderWidth: 1,
			data: [
							[0,0,1],[0,1,1],[0,2,4],[0,3,4],[0,4,4],
							[1,0,2],[1,1,4],[1,2,1],[1,3,1],[1,4,3],
							[2,0,3],[2,1,1],[2,2,2],[2,3,4],[2,4,2],
							[3,0,4],[3,1,3],[3,2,4],[3,3,1],[3,4,1],
							[4,0,3],[4,1,4],[4,2,3],[4,3,1],[4,4,1],
							[5,0,4],[5,1,2],[5,2,2],[5,3,4],[5,4,2],
							[6,0,3],[6,1,4],[6,2,4],[6,3,3],[6,4,3],
							[7,0,1],[7,1,1],[7,2,1],[7,3,2],[7,4,3]
						],
			dataLabels: {
				enabled: true,
				color: 'white',
